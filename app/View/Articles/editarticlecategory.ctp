<div class="row">
	<ol class="breadcrumb">
		...
		<li><?php echo $this->Html->link('Editar Categoria', array('controller' => 'articles', 'action' => 'newarticlecategory')); ?></li>
	</ol>
	<div class="row">
		<?php echo $this->element('internalbar', array('active' => 'articles', 'action' => '')); ?>
		<div class="col-md-10">
			<div class="framed">
